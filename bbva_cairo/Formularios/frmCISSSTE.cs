...
namespace bbva_cairo.Formularios
{
    public partial class frmCISSSTE : Form
    {
        ...
        private void GetPrestamos()
        {
            ...
            iRes = (int)gObjCPolizas.bGetDetPrestISS(ref RsPrestamos, Modulos.ModGeneral.gsConexion, Modulos.ModGeneral.grsErrADO, vParametros);
        ...
        private void ObtenDescApliFOVI(int No_Prestamo, long iPolizaPrest, string Tpo_Ptmo)
        {
            ...
            iRes = (int)gObjCPolizas.bGetDescAplifOVI(RsDescApliFOVI, Modulos.ModGeneral.gsConexion, Modulos.ModGeneral.grsErrADO, vParametros); //.bGetDescApliFOVI(RsDescApliFOVI, gsConexion, grsErrADO, vParametros);
